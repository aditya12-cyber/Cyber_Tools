...
print(Fore.RED + Style.BRIGHT + "Opening tool")
time.sleep(2)

for i in range(3):
    print(Fore.RED + Style.BRIGHT + "wait....")
    time.sleep(1)
time.sleep(4)
...
time.sleep(2)
print( Fore.GREEN + Style.BRIGHT + "                       \  /       |      |_____|    |       |         /           ")
time.sleep(2)
print( Fore.GREEN + Style.BRIGHT + "                        \/        |      |\         |_______|        /__________  ")
time.sleep(2)
print( Fore.CYAN + Style.BRIGHT + "                                         | \                                      ")
time.sleep(2)
...
print(Fore.RED + " Use This tool Only if you know to come back to our initial position . ")
print("")
user = input(" Enter -> ")
...
if ( user == "01" or user == "1"):
    ...
    if ( answer == "y"):
        ...
        for i in range(100):
            ...
            print (Fore.BLUE + Back.RED + Style.BRIGHT + " ok ! Get lost....")
            time.sleep(1)
...
###--------------------------- triple six virus -------------------------------###
    ...
    if ( answer2 == "y"):
        ...
        while True:
            ...
            print(Fore.RED + Style.BRIGHT + Back.BLACK +"you are hacked")
            time.sleep(1)
        ...
        for i in range(100):
            ...
            print( Fore.BLUE + Back.BLACK + Style.BRIGHT + "Ok! Get lost") 
            time.sleep(1)   
...
### ----------------------------Hackster virus -------------------------------###
    ...
    if ( answer3 == "y" ):
        ...
        time.sleep(1)
        print("")
        print( Fore.YELLOW + Style.BRIGHT + "you want to hack...")
        time.sleep(1)
        print("")
        print("")
        print( Fore.MAGENTA + Style.BRIGHT + "1) email")
        print( Fore.MAGENTA + Style.BRIGHT + "2) phone number")
        print( Fore.MAGENTA + Style.BRIGHT + "3) trace ip address")
